            ...
            <div class="col-md-6">
                <div class="card card-bordered">
                    <div class="card-header">
                        <h4 class="card-title"><strong>Chat: ADMINISTRADOR</strong></h4>
                    </div>
                    ...
                    <form action="registrar_mensaje.php" method="POST" enctype="multipart/form-data">
                        <div class="publisher bt-1 border-light">
                            ...
                            <input name="enviar_mensaje" id="enviar_mensaje" type="submit" class="publisher-btn text-info">
                    </form>

                    <form action="registrar_archivo.php" method="POST" enctype="multipart/form-data">
                        <div class="publisher bt-1 border-light">
                            <span>
                                <i></i>
                                <input name="documento" id="documento" type="file">
                            </span>
                            <input type="submit" name="enviar_documento" id="enviar_documento" class="publisher-btn text-info">
                    </form>
                </div>
                </form>
            </div>
